#hacer un hola mundo con Python

print("hola mundo, bienvenidos al lenguajes de programación Python")
...
print(type(print("esto es un comentario"))) # devuelve un NonType (no es un tipo de dato)
